    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-officially-a-doctor",
          ...
          description: "",
          section: "News",},{id: "projects-mitigation-strategies-for-airborne-infection-control",
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-urban-heat-air-quality-and-vehicle-emission-studies",
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-claire-lshm22032-clean-air-for-everyone-project",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%70.%71%69%6E@%74%75%65.%6E%6C", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/Peng-Qin-94", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/peng-qin-84b7a410b", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
        section: 'Socials',
        handler: () => {
          window.open("https://orcid.org/0000-0001-7408-7522", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=p6AH1wMAAAAJ", "_blank");
        },
      },{
        id: 'social-scopus',
        title: 'Scopus',
        section: 'Socials',
        handler: () => {
          window.open("https://www.scopus.com/authid/detail.uri?authorId=57203857227", "_blank");
        },
      },{
      id: 'light-theme',
